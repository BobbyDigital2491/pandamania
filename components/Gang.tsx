...
export default function Gang() {
  ...
  <h1 className="text-5xl font-bold leading-none text-center">Change is here!!!</h1>
		...
		<h1 className="text-3xl font-bold leading-none text-center">PMX Collections and Point System</h1>
		<p className="pt-2 pb-8 text-xl font-medium text-center">
			PMX Collections consist of 3 different art bases, Samurai, Mutants, and Mundanes. With a collection size of 2,222 that will
